    ...
    internal class IPEndPointConverter : JsonConverter
    {
        ...
        public static string str(this VRC.Player player)
        {
            return $"{player.prop_PlayerNet_0.field_Private_PhotonView_0.field_Private_Int32_0.str()} {player.prop_APIUser_0.displayName.str()} ({player.prop_APIUser_0.id})";
        }
